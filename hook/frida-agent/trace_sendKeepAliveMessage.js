...
setImmediate(function () {
  ...
  // === 配置区 ===
  const PARENT_CLASS = 'APSCourierConnection';
  const PARENT_SEL = '- sendKeepAliveMessageWithMetadata:onInterface:'; // 你的 #1
  ...
  Interceptor.attach(parentImp, {
    ...
    onLeave(retval) {
      ...
      if (stack && stack.length === 0) activeStacks.delete(this.threadId);
